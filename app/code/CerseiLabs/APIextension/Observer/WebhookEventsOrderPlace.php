...
class WebhookEventsOrderPlace implements ObserverInterface
{
    /**
        ...
        StoreManagerInterface $_storeManager)
    {
        ...
        $this->eventCode = 'sales_order_place_after';
        $this->helper = $helper;
    ...
    public function execute(Observer $observer)
    {
        ...
        $subEntities = array();
        $this->helper->runWebHook($baseUrl, $this->_collectionFactory, $this->eventCode, 'order', $observer, $subEntities);
    }
}
