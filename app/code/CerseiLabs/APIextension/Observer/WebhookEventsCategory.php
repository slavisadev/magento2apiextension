...
class WebhookEventsCategory implements ObserverInterface
{
    /**
        ...
        StoreManagerInterface $_storeManager)
    {
        ...
        $this->eventCode = 'catalog_category_prepare_save';
        $this->helper = $helper;
    ...
    public function execute(Observer $observer)
    {
        ...
        $subEntities = array();
        $this->helper->runWebHook($baseUrl, $this->_collectionFactory, $this->eventCode, 'category', $observer, $subEntities);
    }
}
